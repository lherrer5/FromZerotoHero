...
if (palabrA[0].toLowerCase()=== "a" || palabrA[0].toLowerCase()=== "e" || palabrA[0].toLowerCase()=== "i" || palabrA[0].toLowerCase()=== "o"|| palabrA[0].toLowerCase()=== "u"){
        console.log("Inicia con vocal")
} else{
    console.log("Inicia con consonante o algo q no es vocal")
}
